//
//  EssentialFeedJorgeAPIEndToEndTests.swift
//  EssentialFeedJorgeAPIEndToEndTests
//
//  Created by jfuentescasillas on 11/08/23.
//
...
final class EssentialFeedJorgeAPIEndToEndTests: XCTestCase {
    func test_endToEndTestServerGETFeedResult_matchedFixedTestAccountData() {
        ...
        case let .success(imageFeed)?:
            ...
            // Use this when there are an uncertain number of items...
            /* items.enumerated().forEach { (idx, item) in
             XCTAssertEqual(item, expectedItem(at: idx), "Unexpected item values at index \(idx)")
             } */
            
            //...but since we only have 8 items, we'll use this configuration:
