...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_loadingFeedIndicator_isVisibleWhileLoadingFeed() {
        ...
        XCTAssertFalse(sut.isShowingLoadingIndicator, "Expected no loading indicator once loading is successfully completed")
    ...
    func test_loadFeedCompletion_doesNotAlterCurrentRenderingStateOnError() {
        ...
        sut.loadViewIfNeeded()
        loader.completeFeedLoading(with: [img0], at: 0)
        assertThat(sut, isRendering: [img0])
...
private extension FeedViewController {
    ...
    func simulateFeedImageViewVisible(at idx: Int) {
        _ = feedImageView(at: idx)
    }
